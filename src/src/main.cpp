...
int main() {
    ...
    try {
        ...
        // Добавляем материалы
        auto material = std::make_shared<Material>(1, 14.828, 0.4876, 1);
        assembly->addMaterial(material);
        //
        ...
        int circumferentialNodes = 51;  // Узлов по окружности
        ...
        double maxContactPressure = 1.3662;     // 1 МПа максимальное давление
